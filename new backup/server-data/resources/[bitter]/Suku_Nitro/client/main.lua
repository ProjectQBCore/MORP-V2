...
Citizen.CreateThread(function()
    while true do
        ...
        if IsInstallingNitro then
            ESX.ShowNotification('Installing NITRO')
            Wait(4000)
        end
    end
end)
...
AddEventHandler('suku:UninstallNitroFromVehicle', function(vehicle, plate)
    ...
    if breakchance == 13 then
        ...
        ESX.ShowNotification('Vehicle is BROKEN')
    else
        ESX.ShowNotification('NITRO Uninstalled')
    end
                ...
                if GetPedInVehicleSeat(veh, -1) == ped then
                    ...
                    if isVehicleMarked then
                        ...
                        if nitroVehicle.amount > 0 then
                            ...
                            Citizen.InvokeNative(0x93A3996368C94158, veh, 5.0)
                            nitroUsed = true
