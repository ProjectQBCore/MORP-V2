Locales['en'] = {
  ['you_paid'] = 'you paid ~g~$%s~s~ to the MORP Driving School',
  ...
  ['gratz_stay_alert'] = 'i\'m impressed, but don\'t forget to stay ~r~Focused~s~ whilst driving!',
  ...
  ['road_test_car'] = 'Learners Road Test',
  ['road_test_bike'] = 'Motorcycle Skills Test',
  ['road_test_truck'] = 'Truck Skills Test',
  ['road_test_bus'] = 'Bus Skill Test',
  ['school_item'] = '$%s',
  ['driving_school'] = 'MORP Driving School',
  ['press_open_menu'] = 'press ~INPUT_CONTEXT~ to open the menu',
  ['driving_school_blip'] = 'MVD',
  ['driving_test_complete'] = 'Learners driving test completed',
  ...
  ['not_enough_money'] = 'You are broke to take the test (Insufficient Funds)',
}
