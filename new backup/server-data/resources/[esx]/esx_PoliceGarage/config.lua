...
Config.HeliGarageName = "Police helicopter"
...
Config.BoatGarageName = "Police Boat"
...
Config.ExtraGarageName = "Auto Extras"
...
Config.PoliceVehicles = {
		{ model = '', label = '-----AUTO-----'},
		{ model = 'polaudi', label = 'Audi A6'},
		{ model = 'polpassat', label = 'Volkswagen Passat'},
		{ model = 'polvolvo70', label = 'Volvo 70'},
		{ model = 'poltoyota', label = 'Toyota'},
		{ model = 'poltouran2016', label = 'VW Touran 2016'},
		{ model = 'poltouran2011', label = 'VW Touran 2011'},
		{ model = 'poltransporter5', label = 'VW Transporter 5'},
		{ model = 'poltransporter6', label = 'VW Transporter 6'},
		{ model = '', label = '-----MOTOR--------'},		
		{ model = 'polmotor', label = 'Straat Motor'},	
		{ model = 'polmotor2', label = 'Offroad Motor'},
		{ model = 'polmotor3', label = 'Straat Motor'},		
		{ model = '', label = '-----FIETS--'},		
		{ model = 'polfiets', label = 'Politie Fiets'}
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Place the vehicle in the garage"
Config.LabelGetVeh = "Take a service vehicle"
...
Config.VehicleParked = "Vehicle is in the garage!"
Config.NoVehicleNearby = "You don't have a vehicle!"
Config.CarOutFromPolGar = "Car removed from garage !!"
Config.HeliOutFromPolGar = "Helicopter taken from garage!"
