...
AddEventHandler('policealerts:client:AddPoliceAlert', function(data, forBoth)
    if forBoth then
        if (ESX.GetPlayerData().job.name == "police" or ESX.GetPlayerData().job.name == "mvd" or ESX.GetPlayerData().job.name == "ambulance") then
        ...
        if ESX.GetPlayerData().job.name == 'police' or ESX.GetPlayerData().job.name == "mvd" then
...
Citizen.CreateThread(function()
    ...
    if IsPedShooting(playerPed) and not IsPedCurrentWeaponSilenced(playerPed) and getWeapon(number) ~= "Unknown" and ESX.PlayerData.job.name ~= 'police' and ESX.PlayerData.job.name ~= 'mvd' --[[or IsPedShooting(playerPed) and not IsPedCurrentWeaponSilenced(playerPed) and getWeapon(number) ~= "Unknown" and ESX.PlayerData.job.name ~= 'mvd']] then
...
RegisterNetEvent('mvdalerts:client:AddPoliceAlert')
AddEventHandler('mvdalerts:client:AddPoliceAlert', function(data, forBoth)
    if forBoth then
        if (ESX.GetPlayerData().job.name == "police" or ESX.GetPlayerData().job.name == "mvd" or ESX.GetPlayerData().job.name == "ambulance") then
            if data.alertTitle == "Assistentie collega" or data.alertTitle == "Assistentie Ambulance" or data.alertTitle == "Assistentie Doctor" then
                TriggerServerEvent("InteractSound_SV:PlayOnSource", "emergency", 0.7)
        ...
        if ESX.GetPlayerData().job.name == 'mvd' then
