...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.realestateStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.realestateStations[station].AuthorizedWeapons[i]
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_realestatejob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.realestateStations[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'realestate', vehicleProps)
    ...
    for i=1, #Config.realestateStations[station].AuthorizedVehicles, 1 do
      local vehicle = Config.realestateStations[station].AuthorizedVehicles[i]
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_realestatejob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_realestatejob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_realestatejob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_realestatejob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_realestatejob:getOtherPlayerData', function(data)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_realestatejob:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_realestate', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_realestatejob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_realestatejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_realestatejob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_realestatejob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_realestatejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_realestatejob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_realestatejob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_realestatejob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_realestatejob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_realestatejob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_realestatejob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.realestateStations[station].Helicopters
    ...
    if not IsAnyVehicleNearPoint(helicopters[partNum].SpawnPoint.x, helicopters[partNum].SpawnPoint.y, helicopters[partNum].SpawnPoint.z,  3.0) then
      ...
      ESX.Game.SpawnVehicle('maverick', {
        ...
        SetVehicleCustomPrimaryColour(vehicle, 255,227,51)
        TriggerServerEvent('garage:addKeys', GetVehicleNumberPlateText(vehicle))
      end)
...
AddEventHandler('esx_realestatejob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_realestatejob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'realestate' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_realestatejob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_realestatejob:handcuff')
AddEventHandler('esx_realestatejob:handcuff', function()
...
RegisterNetEvent('esx_realestatejob:drag')
AddEventHandler('esx_realestatejob:drag', function(cop)
...
RegisterNetEvent('esx_realestatejob:putInVehicle')
AddEventHandler('esx_realestatejob:putInVehicle', function()
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'realestate' then
      ...
      for k,v in pairs(Config.realestateStations) do
        ...
        for i=1, #v.Armories, 1 do
          if GetDistanceBetweenCoords(coords,  v.Armories[i].x,  v.Armories[i].y,  v.Armories[i].z,  true) < 0.5 then
            DrawText3D(v.Armories[i].x,  v.Armories[i].y,  v.Armories[i].z, "~y~ E ~w~- Stash~w~")
        ...
        for i=1, #v.Vehicles, 1 do
          if GetDistanceBetweenCoords(coords,  v.Vehicles[i].Spawner.x,  v.Vehicles[i].Spawner.y,  v.Vehicles[i].Spawner.z,  true) < 0.5 then
            DrawText3D(v.Vehicles[i].Spawner.x,  v.Vehicles[i].Spawner.y,  v.Vehicles[i].Spawner.z, "~y~ E ~w~- Vehicle~w~")
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'realestate' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            if
              GetEntityModel(vehicle) == GetHashKey('jpbuggy')  or
