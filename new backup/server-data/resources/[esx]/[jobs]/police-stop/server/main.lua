...
local handscuffs = {}
local url = 'https://discordapp.com/api/webhooks/749015016753332265/qCZnm0beZluWjZlrNjDTz25JJPWvMtSZKr3N4nAaOD8lXXj-MyUI0Dm7LiAZZEdUmf_L'
...
RegisterServerEvent('police:sheriffpersonalStash')
AddEventHandler('police:sheriffpersonalStash' , function()
    local Steam = GetPlayerIdentifiers(source)[1]
