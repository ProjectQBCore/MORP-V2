Locales['en'] = {
  ...
  -- Armory
  ['get_weapon'] = 'קבלת נשקים',
  ['put_weapon'] = 'הכנסת נשקים',
  ['buy_weapons'] = 'רכישת נשקים',
  ['get_stock'] = 'קבלת פריט',
  ['put_stock'] = 'הכנס פריט',
  ['armory'] = 'נשקייה',
  ...
  -- Action Menu
  ['citizen_interaction'] = 'פשע על אזרחים',
  ['vehicle_interaction'] = 'בדיקת רכבים',
  ['object_spawner'] = 'זימון חפצים',
  ['animations'] = 'animations',

  ['id_card'] = 'ת.ז של השחקן',
  ['search'] = 'חיפוש על השחקן',
  ['handcuff'] = 'לשים אזיקים / להוריד אזיקים',
  ['drag'] = 'למשוך את השחקן',
  ['put_in_vehicle'] = 'להכניס את השחקן לרכב',
  ['out_the_vehicle'] = 'להוציא את השחקן מהרכב',
  ['fine'] = 'fine',
  ['no_players_nearby'] = 'no players nearby',

  ['vehicle_info'] = 'לשלוף מידע על הרכב שלידך',
  ['pick_lock'] = 'לפרוץ רכבים',
  ['vehicle_unlocked'] = 'vehicle ~g~Unlocked~s~',
  ['no_vehicles_nearby'] = 'no vehicles nearby',
  ['traffic_interaction'] = 'אביוקטים',
  ['cone'] = 'cone',
  ['barrier'] = 'barrier',
  ...
  ['owner'] = 'owner: ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'נשקייה - לקיחת נשקים',
  ['put_weapon_menu'] = 'נשקייה - לשים נשקים שנמצאים באינבנטורי שלך',
  ['buy_weapon_menu'] = 'נשקייה - רכישת נשקים',
