...
local url = 'https://discordapp.com/api/webhooks/749014926533591121/_5a4cScpZdAX3GrcA1zRBRIHHT7_R9Tg896053_8UwD9Wajo9f1Bp-OMqkYULHiAzO2_'

RegisterServerEvent('cardealer:logs')
AddEventHandler('cardealer:logs', function(data, src)
	...
	PerformHttpRequest(url, function(err, text, headers) end, 'POST', json.encode({username = "Car Dealer logs", content = "```css\n[" .. time .. "] " .. data .. "\n " .. msg .. "```"}), {['Content-Type'] = 'application/json'})
end)
