...
ESX.RegisterUsableItem('IceCream', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onEatIceCream', source)
...
ESX.RegisterUsableItem('icecoffee', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onDrinkNoProp', source, 7000)
...
ESX.RegisterUsableItem('viski', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
