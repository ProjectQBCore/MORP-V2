...
SpawnLocalVehicle = function(data)
	...
	ESX.Game.SpawnLocalVehicle(vehicleProps["model"], spawnpoint["position"], spawnpoint["heading"], function(yourVehicle)
        ...
        TriggerServerEvent('garage:addKeys', GetVehicleNumberPlateText(yourVehicle))
...
SpawnVehicle = function(data,recuperar)
	...
	ESX.Game.SpawnVehicle(vehicleProps["model"], spawnpoint["position"], spawnpoint["heading"], function(yourVehicle)
        ...
        TriggerServerEvent('garage:addKeys', GetVehicleNumberPlateText(yourVehicle))
        Citizen.Wait(100)
        TriggerServerEvent('garage:modifystate', vehicleProps, 0, nil)
...
SaveInGarage = function(garage)
    ...
    TriggerEvent('notification', 'You saved your vehicle in garage '..garage, 1)
    Citizen.Wait(500)

    deleteCar(vehicle)
    TriggerServerEvent('garage:modifystate', vehicleProps, 1, garage)
    CloseMenu()
end
...
DrawScriptMarker = function(markerData)
    DrawMarker(20, markerData["pos"], 0, 0, 0, 0, 0, 0, 0.701, 1.0001, 0.3001, 222, 50, 50, 0.05, 0, 0, 0, 0, 0, 0, 0) --old
	--DrawMarker(20, markerData["pos"], 0, 0, 0, 0, 0, 0, 0.701, 1.0001, 0.3001, 222, 50, 0, 50, 0, 0, 0, 0, 0, 0, 0) --exp
