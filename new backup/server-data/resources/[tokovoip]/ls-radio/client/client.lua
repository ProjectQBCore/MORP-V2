...
RegisterNUICallback('joinRadio', function(data, cb)
    ...
    if tonumber(data.channel) ~= tonumber(getPlayerRadioChannel) then
        if tonumber(data.channel) <= Config.RestrictedChannels then
          if(PlayerData.job.name == 'police' or PlayerData.job.name == 'mvd' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'fbi' or PlayerData.job.name == 'taa' or PlayerData.job.name == 'pm' or PlayerData.job.name == 'court') then
          ...
          elseif not (PlayerData.job.name == 'police' or PlayerData.job.name == 'mvd' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'fbi' or PlayerData.job.name == 'taa' or PlayerData.job.name == 'pm' or PlayerData.job.name == 'court') then
            --- info that you cannot join because you are not a policeman
