Locales['en'] = {
  ...
  ['get_weapon'] = 'Take out weapons',
  ['put_weapon'] = 'Deposit Weapons',
  ['buy_weapons'] = 'buy weapons',
  ['get_stock'] = 'Withdraw Goods',
  ['put_stock'] = 'Deposit Merchandise',
  ['armory'] = 'armory',
  ...
  -- Action Menu
  ['citizen_interaction'] = 'Citizens',
  ['vehicle_interaction'] = 'Vehicles',
  ['object_spawner'] = 'Launch Objects',

  ['id_card'] = 'Look for an ID',
  ['search'] = 'Body search',
  ['handcuff'] = 'Handcuffs / Download handcuffs',
  ['drag'] = 'Drag',
  ['put_in_vehicle'] = 'Put in the car',
  ['out_the_vehicle'] = 'Throw out of the car',
  ['fine'] = 'Report',
  ...
  -- Vehicle interaction
  ['vehicle_info'] = 'Check vehicle details',
  ['pick_lock'] = 'Car burglary',
