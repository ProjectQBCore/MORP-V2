Locales['en'] = {
  ...
  ['get_stock'] = 'הוצא סחורה',
  ['put_stock'] = 'הכנס סחורה',
  ['armory'] = 'armory',
  ...
  ['object_spawner'] = 'שיגור אובייקטים',

  ['id_card'] = 'חפש תעודת זהות',
  ['search'] = 'חיפוש גופני',
  ['handcuff'] = 'אזיקה / הורד אזיקה',
  ['drag'] = 'גרור',
  ['put_in_vehicle'] = 'הכנס לרכב',
  ['out_the_vehicle'] = 'הוצא מהרכב',
  ['fine'] = 'דוח',
