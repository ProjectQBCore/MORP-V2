...
Territories = {
  ...
  ["Tongva Hills"] = {
    ...
    zone = "TONGVAH",                                      -- Probably don't change this unless you intend on moving the zones around.
    ...
    areas = {                                             -- Areas are responsible for the large square blips on the map.
      [1] = { 
        location  = vector3(-2089.99, 1997.71, 200.35),
        width     = 990.0,
        height    = 585.0,
        heading   = 298.86,
        display   = 10
    ...
    blipData = {                                          -- BlipData is responsible for the blip corresponding to the entry action of this zone.
      pos = vector3(-1862.74,2053.85,135.46),
      sprite = 500,
      color = 1,
    ...
    actions = { 
      ["entry"] = {
        ...
        location = vector3(-1862.74,2053.85,135.46),
      },
      ["exit"] = {
      ...
      ["gather_money"] = {
        ...
        requireCash = false,                              -- If not requireItem, requireCash instead. NOTE: Always dirty.
  ...
  ["Richman"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(-1666.93, 293.31, 72.36),
        width     = 320.0,
        height    = 560.0,
        heading   = 100.67,
        display   = 10
      ...
      [2] = {
        location  = vector3(-1561.38, 47.83, 72.36),
        width     = 220.0,
        height    = 430.0,
        heading   = 100.67,
        display   = 10
    ...
    blipData = {
      pos = vector3(-1541.37, 91.96, 53.9),
      sprite = 496,
      color = 2,
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(-1541.37, 91.96, 53.9),
      },
      ["exit"] = {
  ...
  ["Grapeseed"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(2006.62, 4942.97, 70.97),
        width     = 500.0,
        height    = 900.0,
        heading   = 93.14,
        display   = 10
      ...
      [2] = {
        location  = vector3(2523.67, 4510.07, 70.97),
        width     = 500.0,
        height    = 800.0,
        heading   = 25.3,
        display   = 10
    ...
    blipData = {
      pos = vector3(2448.88, 4979.88, 46.81),
      sprite = 499,
      color = 3,
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(2448.88, 4979.88, 46.81),
      },
      ["exit"] = {
  ...
  ["Rancho"] = {
    ...
    areas = {
      ...
      [2] = {
        location  = vector3(465.24, -1821.77, 28.96141),
        width     = 310.0,
        height    = 220.0,
        heading   = 250.40,
        display   = 10
    ...
    blipData = {
      pos = vector3(349.33, -2016.86, 22.39),
      sprite = 497,
      color = 0,
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(349.33, -2016.86, 22.39),
      },
      ["exit"] = {
