...
TicketPrice				= 20	-- Change to any value YOU think is suitable for a Metro Ticket in your (RP) Server
...
Message['en'] = {
	...
	['los_santos_transit'] = "MORP Transit",
	...
	['stop_toolate'] = "Sorry, it seems that your station has passed, you'll have to wait for the next station.",
	['sorry'] = "Sorry",
	['exit_metro_random'] = ", but it's not allowed to randomly exit the Metro. Please wait for the next station!",
	['Sir'] = "sir",
	['Miss'] = "Ma'am",
	['need_ticket'] = "Sorry, You will need to buy a MORP Metro Ticket first.",
	...
	['terrorist'] = "We will NOT tolerate terrorist behaviour on MORP public transport vehicles!",
	['no_metro_spawned'] = "Our Appologies, something has gone terribly wrong, you have received a free ticket!",
	['travel_metro'] = "Thank you for traveling with MORP Transit.",
}
