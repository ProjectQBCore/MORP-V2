...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlPressed(0, Keys['LEFTSHIFT']) and IsControlPressed(0, Keys['E']) and not isTackling and ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' or IsControlPressed(0, Keys['LEFTSHIFT']) and IsControlPressed(0, Keys['E']) and not isTackling and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mvd' then
			Citizen.Wait(10)
