...
Citizen.CreateThread(function()
    while true do
      ...
      if (IsControlJustPressed(1, Config.openKey)) then
            ...
            if isInVehicle() and playerData.job.name == "police" then --or isInVehicle() and playerData.job.name == "mvd" then 
...
Citizen.CreateThread(function()
    while isLoading == true do 
        ...
        if ESX.IsPlayerLoaded(PlayerId) and playerData.job.name == "police" then --or ESX.IsPlayerLoaded(PlayerId) and playerData.job.name == "mvd" then 
