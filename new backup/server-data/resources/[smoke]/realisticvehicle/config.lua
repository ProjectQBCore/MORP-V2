...
Config = {
	...
	engineSafeGuard = 800.0,					-- Final failure value. Set it too high, and the vehicle won't smoke when disabled. Set too low, and the car will catch fire from a single bullet to the engine. At health 100 a typical car can take 3-4 bullets to the engine before catching fire.
	...
	limpModeMultiplier = 0.50,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
