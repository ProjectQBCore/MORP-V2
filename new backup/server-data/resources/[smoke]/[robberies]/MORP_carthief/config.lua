...
-- BLIP:
	...
	blipName = "Car Robbery",					-- set name of the blip
...
Config.CarThiefNPCName 		= "Underworld Dealer"   	-- set name for NPC (the name that pops on on your phone example)
...
Config.RiskGrades = {
	[1] = { -- Risk Grade 1 --
		Grade = 1, Label = 'Low', Enabled = true, BuyPrice = 500, MinCops = 1, 
		Cars = {
			[1] = { Name = "Tempesta", Hash = 272929391, Reward = 850 },
			[2] = { Name = "Pfister 811", Hash = -1829802492, Reward = 950 },
			[3] = { Name = "Sultan RS", Hash = -295689028, Reward = 700 },
			-- add more cars here
		}, 
	},
	[2] = { -- Risk Grade 2 --
		...
		Cars = {
			[1] = { Name = "Infernus", Hash = 418536135, Reward = 3350 },
			[2] = { Name = "Reaper", Hash = 234062309, Reward = 3150 },
			[3] = { Name = "FMJ", Hash = 1426219628, Reward = 3950 },
			-- add more cars here
		}, 	
	},
	[3] = { -- Risk Grade 3 --
		Grade = 3, Label = 'High', Enabled = true, BuyPrice = 4000, MinCops = 2, 
		Cars = {
			[1] = { Name = "T20", Hash = 1663218586, Reward = 6350 },
			[2] = { Name = "XA-21", Hash = 917809321, Reward = 5950 },
			[3] = { Name = "Zentorno", Hash = -1403128555, Reward = 5350 },
			-- add more cars here
		}, 
	},
}
...
--[[
	[1] = { 
		...
		Goons = {
			NPC1 = {
				...
				accuracy = 80,												-- NPC Hitting/Shooting accuracy
			},	
			NPC2 = {
	...
	[1] = {
		...
		Goons = {
			NPC1 = {
				Pos = {-1805.69, 404.78, 113.2}, h = 207.48,
				ped = 's_m_y_dealer_01',
				animDict = 'amb@world_human_cop_idles@female@base',
				animLib = 'base',						
				weapon2 = 'WEAPON_BAT',
			...
			NPC2 = {
				Pos = {-1784.49, 408.97, 113.65}, h = 116.71,
				ped = 's_m_y_dealer_01',
				animDict = 'rcmme_amanda1',
				animLib = 'stand_loop_cop',
				weapon2 = 'WEAPON_KNIFE',
	...
	[2] = {
		...
		Goons = {
			NPC1 = {
				Pos = {2928.98, 4631.01, 48.55}, h = 0.62,
				ped = 's_m_y_dealer_01',
				animDict = 'amb@world_human_cop_idles@female@base',
				animLib = 'base',						
				weapon2 = 'WEAPON_BAT',
			...
			NPC2 = {
				Pos = {2933.99, 4628.02, 48.72}, h = 56.42,
				ped = 's_m_y_dealer_01',
				animDict = 'rcmme_amanda1',
				animLib = 'stand_loop_cop',
				weapon2 = 'WEAPON_KNIFE',
	...
	[3] = {
		...
		Goons = {
			NPC1 = {
				Pos = {-1634.52, 3026.97, 23.91}, h = 201.9,
				ped = 's_m_y_dealer_01',
				animDict = 'amb@world_human_cop_idles@female@base',
				animLib = 'base',						
				weapon2 = 'WEAPON_BAT',
			...
			NPC2 = {
				Pos = {-1637.97, 3021.28, 31.83}, h = 251.72,
				ped = 's_m_y_dealer_01',
				animDict = 'rcmme_amanda1',
				animLib = 'stand_loop_cop',
				weapon2 = 'WEAPON_KNIFE',
