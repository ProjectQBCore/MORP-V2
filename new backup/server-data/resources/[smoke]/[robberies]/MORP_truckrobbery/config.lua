...
Config.JobFees = 250			-- Amount of money to start a job
...
Config.CooldownTimer = 30		-- set cooldown time in minutes, before a player can start a job again

Config.HasItemLabel = true		-- set to false if your ESX vers. doesnt support item labels

Config.Reward = {min = 22000, max = 35000, dirty = true}
Config.ItemReward = {
	enable = false,
	items = {
