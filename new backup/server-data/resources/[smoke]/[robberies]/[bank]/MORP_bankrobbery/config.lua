...
-- Police Settings:
Config.PoliceJobs = {"police", "mvd"}	-- Jobs that can't do bankrobberies etc, but can secure the banks.

-- Alert Blip
Config.AlertBlipShow = true			-- enable or disable blip on map on police notify
Config.AlertBlipTime = 30000		-- miliseconds that blip is active on map (this value is multiplied with 4 in the script)
...
Config.Banks = {
    [1] = {
		...
		deskCash = {
			[1] = {pos = {151.13,-1042.02,29.37}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {149.7,-1041.48,29.37}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {148.08,-1040.85,29.37}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
    ...
    [2] = {
		...
		deskCash = {
			[1] = {pos = {315.42,-280.26,54.16}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {313.7,-279.59,54.16}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {312.08,-279.07,54.16}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
	...
	[3] = {
		...
		deskCash = {
			[1] = {pos = {-349.61,-51.04,49.04}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {-351.3,-50.47,49.04}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {-353.09,-49.86,49.04}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
	...
	[4] = {
		...
		deskCash = {
			[1] = {pos = {-1210.58,-330.75,37.78}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {-1211.99,-331.45,37.78}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {-1213.63,-332.28,37.78}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
	...
	[5] = {
		...
		deskCash = {
			[1] = {pos = {1173.16,2707.75,38.09}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {1174.9,2707.76,38.09}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {1176.59,2707.73,38.09}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
	...
	[6] = {
		...
		deskCash = {
			[1] = {pos = {-2961.67,484.62,15.7}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {-2961.76,482.99,15.7}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {-2961.83,481.25,15.7}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
	...
	[7] = {
		...
		blip = { enable = true, bName = "Blaine Bank", display = 4, sprite = 431, color = 5, scale = 0.7 },
		inUse = false, minCops = 1,
		...
		deskCash = {
			[1] = {pos = {-113.64,6471.79,31.63}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {-112.32,6470.43,31.63}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {-111.27,6469.37,31.63}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
	...
	[8] = {
		...
		blip = { enable = true, bName = "Pacific Standard Bank", display = 4, sprite = 431, color = 5, scale = 0.7 },
		inUse = false, minCops = 0,
		...
		deskCash = {
			[1] = {pos = {242.64,226.22,106.29}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[2] = {pos = {247.76,224.27,106.29}, robbed = false, reward = {dirty = true, min = 800, max = 1000}},
			[3] = {pos = {252.88,222.43,106.29}, robbed = false, reward = {dirty = true, min = 800, max = 1000}}, 
		},
...
Config.SafeItemRewards = {
	[1] = { item = "goldbar", chance = 65, min = 1, max = 2},
	[2] = { item = "goldwatch", chance = 85, min = 15, max = 20},
	[3] = { item = "pearl_necklace", chance = 40, min = 10, max = 14},
	[4] = { item = "10ct_gold_chain", chance = 25, min = 1, max = 2},
}

Config.SafeMoneyReward = {{
	dirtyCash = true,			-- set to false to receive normal cash
	minAmount = 1,				-- this value is multiplied with 1000 in script, so 15 means 15.000$
	maxAmount = 2,				-- this value is multiplied with 1000 in script, so 30 means 30.000$
}}
...
Config.Safes = {
	...
	-- Casino (By Smoke)
	-- room1
	[46] = { pos = {969.22,52.5, 59.83}, AnimPos = {969.22,52.5, 59.83}, AnimHeading = 81.38,  robbed = false, failed = false },
	[47] = { pos = {969.37,47.26,59.83}, AnimPos = {969.37,47.26,59.83}, AnimHeading = 97.4,   robbed = false, failed = false },
	[48] = { pos = {973.69,37.73,59.83}, AnimPos = {973.69,37.73,59.83}, AnimHeading = 136.51, robbed = false, failed = false },
	[49] = { pos = {982.1,31.71, 59.83}, AnimPos = {982.1,31.71, 59.83}, AnimHeading = 164.24, robbed = false, failed = false },
	[50] = { pos = {984.65,30.91,59.83}, AnimPos = {984.65,30.91,59.83}, AnimHeading = 174.37, robbed = false, failed = false },
	[51] = { pos = {970.91,41.26,59.83}, AnimPos = {970.91,41.26,59.83}, AnimHeading = 120.99, robbed = false, failed = false },
	--room2
	[52] = { pos = {989.86,30.3, 59.83}, AnimPos = {989.86,30.3, 59.83}, AnimHeading = 175.14, robbed = false, failed = false },
	[53] = { pos = {995.01,31.13,59.83}, AnimPos = {995.01,31.13,59.83}, AnimHeading = 195.62, robbed = false, failed = false },
	[54] = { pos = {1005.58,38.64,59.83}, AnimPos = {1005.58,38.64,59.83}, AnimHeading = 237.59, robbed = false, failed = false },
	[55] = { pos = {1008.83,45.78,59.83}, AnimPos = {1008.83,45.78,59.83}, AnimHeading = 262.5,  robbed = false, failed = false },
	[56] = { pos = {1009.39,51.03,59.83}, AnimPos = {1009.39,51.03,59.83}, AnimHeading = 273.49, robbed = false, failed = false },
	[57] = { pos = {1009.04,53.64,59.83}, AnimPos = {1009.04,53.64,59.83}, AnimHeading = 273.45, robbed = false, failed = false },
	--room3
	[58] = { pos = {985.99,70.32,59.83}, AnimPos = {985.99,70.32,59.83}, AnimHeading = 12.19, robbed = false, failed = false },
	[59] = { pos = {988.66,70.47,59.83}, AnimPos = {988.66,70.47,59.83}, AnimHeading = 6.62, robbed = false, failed = false },
	[60] = { pos = {996.48,69.24,59.83}, AnimPos = {996.48,69.24,59.83}, AnimHeading = 351.17, robbed = false, failed = false },
	[61] = { pos = {1000.94,66.72,59.83}, AnimPos = {1000.94,66.72,59.83}, AnimHeading = 324.1, robbed = false, failed = false },
}
