...
RegisterNetEvent('mvd:client:ActiveCamera')
AddEventHandler('mvd:client:ActiveCamera', function(cameraId)
...
RegisterNetEvent('mvd:client:DisableAllCameras')
AddEventHandler('mvd:client:DisableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = false
    end
end)

RegisterNetEvent('mvd:client:EnableAllCameras')
AddEventHandler('mvd:client:EnableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = true
    end
end)

RegisterNetEvent('mvd:client:SetCamera')
AddEventHandler('mvd:client:SetCamera', function(key, isOnline)
...
--RegisterCommand('test', function(source, args)
  --  TriggerServerEvent('mvd:addLicense', GetPlayerServerId(PlayerId()))
--end)