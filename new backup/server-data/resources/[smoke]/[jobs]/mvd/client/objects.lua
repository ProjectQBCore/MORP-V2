...
RegisterNetEvent('mvd:client:spawnCone')
AddEventHandler('mvd:client:spawnCone', function()
    Progressbar("spawn_object", "Place object..", 2500, false, true, {
        ...
        TriggerServerEvent("mvd:server:spawnObject", "cone")
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
...
RegisterNetEvent('mvd:client:spawnBarier')
AddEventHandler('mvd:client:spawnBarier', function()
    Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("mvd:server:spawnObject", "barier")
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerEvent('notification', "Canceled..", 2)
    end)
...
RegisterNetEvent('mvd:client:spawnSchotten')
AddEventHandler('mvd:client:spawnSchotten', function()
    Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("mvd:server:spawnObject", "schotten")
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerEvent('notification', "Canceled..", 2)
    end)
...
RegisterNetEvent('mvd:client:spawnTent')
AddEventHandler('mvd:client:spawnTent', function()
    Progressbar("spawn_object", "Place object..", 2500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        ...
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("mvd:server:spawnObject", "tent")
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerEvent('notification', "Canceled..", 2)
    end)
...
RegisterNetEvent('mvd:client:spawnLight')
AddEventHandler('mvd:client:spawnLight', function()
    ...
    Progressbar("spawn_object", "Place object..", 2500, false, true, {
        ...
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerServerEvent("mvd:server:spawnObject", "light")
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "anim@narcotics@trash", "drop_front", 1.0)
        TriggerEvent('notification', "Canceled..", 2)
    end)
...
RegisterNetEvent('mvd:client:deleteObject')
AddEventHandler('mvd:client:deleteObject', function()
    local objectId, dist = GetClosestmvdObject()
    if dist < 5.0 then
        Progressbar("remove_object", "Remove Object..", 2500, false, true, {
            ...
            TriggerServerEvent("mvd:server:deleteObject", objectId)
        end, function() -- Cancel
            StopAnimTask(GetPlayerPed(-1), "weapons@first_person@aim_rng@generic@projectile@thermal_charge@", "plant_floor", 1.0)
            TriggerEvent('notification', "Canceled..", 2)
        end)
...
RegisterNetEvent('mvd:client:removeObject')
AddEventHandler('mvd:client:removeObject', function(objectId)
    NetworkRequestControlOfEntity(ObjectList[objectId].object)
    DeleteObject(ObjectList[objectId].object)
    ObjectList[objectId] = nil
    TriggerServerEvent("mvd:server:setObjects",ObjectList)
end)

RegisterNetEvent('mvd:client:spawnObject')
AddEventHandler('mvd:client:spawnObject', function(objectId, type, player)
...
RegisterNetEvent('mvd:client:SpawnSpikeStrip')
AddEventHandler('mvd:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < SpikeConfig.MaxSpikes then
        if ESX.PlayerData.job.name == "mvd" then
            ...
            spikesSpawned = true
            TriggerServerEvent('mvd:server:SyncSpikes', SpawnedSpikes)
        end
    else
...
RegisterNetEvent('mvd:client:SyncSpikes')
AddEventHandler('mvd:client:SyncSpikes', function(table)
    SpawnedSpikes = table
end)
...
RegisterCommand('remove', function()
    TriggerEvent('mvd:client:deleteObject')
end)

CreateThread(function()
    Wait(100)
    TriggerServerEvent("mvd:server:wantObjects",ObjectList)
end)


RegisterNetEvent("mvd:client:setObjects")
AddEventHandler("mvd:client:setObjects", function(table)
    ObjectList = table
end)