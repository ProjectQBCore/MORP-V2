...
Config.webhook = "https://discord.com/api/webhooks/844246155977162822/EoEB1_lwX0KknZaHvl-P_eBJnK00mPKkGRF767pW2fR5vVdPi53F5T1CD-imWhnzO4mk"						-- Webhook to send logs to discord
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['max_gas_price'] = 15,					-- Maximum price that the owner can apply
