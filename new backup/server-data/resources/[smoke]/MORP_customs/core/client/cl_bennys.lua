...
local bennyLocationTuner = vector3(938.37, -970.82, 39.76) --no ymap not working
local bennyLocationImport = vector3(1001.5,-3170.71, -38.9)  --import not tuner
local bennyLocation = vector3(-211.55, -1324.55, 30.90) --working tuner
local bennyLocationLsone = vector3(731.44, -1088.79, 22.17) --working tuner
local bennyLocationLstwo = vector3(-1155.66, -2007.58, 13.18) --working tuner
local bennyLocationLsthree = vector3(-337.91, -136.88, 39.01) --working tuner
local bennyLocationGsone = vector3(111.14896392822, 6626.283203125, 31.787233352661) --paleto
local bennyLocationGstwo = vector3(1174.6164550781, 2639.1000976562, 37.756870269775) --sandy
...
local bennyHeadingGsone = 53.988410949707
local bennyHeadingGstwo = 6.8205723762512
...
local function saveVehicle()
    ...
    TriggerServerEvent('trp-customs:updateVehicle', myCar)  
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("trp-customs:attemptPurchase", type, upgradeLevel)
