...
--		print(#GetActivePlayers(),'test')
		...
		SetDiscordRichPresenceAsset("morp")
		...
		if Config.UseESXIdentity and playerLoaded then			
			...
			SetRichPresence('ID:' .. GetPlayerServerId(NetworkGetEntityOwner(GetPlayerPed(-1))) .. ' | ' .. GetPlayerName(PlayerId()) .. ' | ' ..' '.. Config.PlayerText ..' ' .. playerCount .. '/' .. tostring(Config.PlayerCount))
        end

        --Here you can add hover text for the "large" icon.
        SetDiscordRichPresenceAssetText('MORP V2')
