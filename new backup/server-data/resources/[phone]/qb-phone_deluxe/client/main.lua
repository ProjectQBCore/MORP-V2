...
while takePhoto do
    ...
    if IsControlJustPressed(1, 27) then -- Toogle Mode
     ...
     exports['screenshot-basic']:requestScreenshotUpload('https://discord.com/api/webhooks/840991509968715786/_8tK4v21qRXAy8woTVSE7FbmuqD4DRjS5pQop_Rw7DGtUoCbk-bGLt62xYFDd8JJCAI2', 'files[]', function(data2)
        DestroyMobilePhone()
...
function GenerateCallId(caller, target)
    local CallId = math.ceil(((tonumber(caller) + tonumber(target)) / 100 * 1)) + 500
    return CallId
end
