...
function getPhoneRandomNumber()
    ...
    while phoneuni do 
        ...
        local numBase2 = math.random(111111, 999999)
        ...
        if result[1] == nil then
            phoneuni = false
            print("unique phn", num)
            return num
        else
            print('duplicate phone number', num)
        end
    end
--    print('Phone number generated', num)
--    return num
end
...
function generateIBAN()
    ...
    while uni do
        ...
        if result[1] == nil then
            uni = false
            print("unique iban", num)
            return num
        else
            print('duplicate iban', num)
        end
    end

--  print('iban generated', num)
--	return num
end
