...
MI.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-text").html(MI.Phone.Data.PlayerData.charinfo.firstname+" "+MI.Phone.Data.PlayerData.charinfo.lastname);
    $("#mail-header-mail").html(MI.Phone.Data.PlayerData.charinfo.firstname+""+MI.Phone.Data.PlayerData.charinfo.lastname+"@gmail.com");
...
MI.Phone.Functions.RefreshAdverts = function(Adverts) {
    ...
    if (Adverts.length > 0 || Adverts.length == undefined) {
        ...
        $(".advert-list").html("");
        var element = '<div class="advert"><span class="advert-sender">No ads yet </span></div>';
        $(".advert-list").append(element);
    }
}