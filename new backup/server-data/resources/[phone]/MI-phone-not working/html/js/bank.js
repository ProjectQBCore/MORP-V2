...
$(document).on('click', '.bank-app-account', function(e){
    ...
    MI.Phone.Notifications.Add("fas fa-university", MI.Phone.Functions.Lang("BANK_TITLE"), "The bank account number has been copied!", "#badc58", 1750);
});
...
MI.Phone.Functions.DoBankOpen = function(data) {
    $(".bank-app-account-number").val("Bank number: " + data.iban);
        ...
        if (amountData >= amount) {
            $.post('http://MI-phone/TransferMoney', JSON.stringify({
                ...
                if (data.CanTransfer) {
                    ...
                    MI.Phone.Notifications.Add("fas fa-university", MI.Phone.Functions.Lang("BANK_TITLE"), "You have $; "+amount+",- transferred!", "#badc58", 1500);
                } else {
    ...
    if (BankBalance >= InvoiceData.amount) {
        $.post('http://MI-phone/PayInvoice', JSON.stringify({
            ...
            if (CanPay) {
                ...
                MI.Phone.Notifications.Add("fas fa-university", MI.Phone.Functions.Lang("BANK_TITLE"), "You have $;"+InvoiceData.amount+" paid!", "#badc58", 1500);
                var amountData = $(".bank-app-account-balance").data('balance');
...
$(document).on('click', '.decline-invoice', function(event){
    ...
    MI.Phone.Notifications.Add("fas fa-university", MI.Phone.Functions.Lang("BANK_TITLE"), "Je hebt $;"+InvoiceData.amount+" betaald!", "#badc58", 1500);
});
