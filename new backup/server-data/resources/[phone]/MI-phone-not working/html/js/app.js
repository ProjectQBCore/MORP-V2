        ...
        if (CanOpenApp) {
            if (MI.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    $("#myPhoneNumber").text(MI.Phone.Data.PlayerData.charinfo.phone_number)
                    ...
                    SetupMeosHome();
				} else if (PressedApplication == "medic") {
                    $.post('http://MI-Phone/GetCurrentMedic', JSON.stringify({}), function(data){
                        SetupMedic(data);
                    });
				} else if (PressedApplication == "police") {
                    $.post('http://MI-Phone/GetCurrentpolice', JSON.stringify({}), function(data){
                        Setuppolice(data);
                    });
				} else if (PressedApplication == "cardealer") {
                    $.post('http://MI-Phone/GetCurrentcardealer', JSON.stringify({}), function(data){
                        Setupcardealer(data);
                    });
				} else if (PressedApplication == "mechanic") {
                    $.post('http://MI-Phone/GetCurrentmechanic', JSON.stringify({}), function(data){
                        Setupmechanic(data);
                    });
                } else if (PressedApplication == "ammu") {
                    $.post('http://MI-phone/GetCurrentAmmu', JSON.stringify({}), function(data){
                        SetupAmmu(data);
                    });
