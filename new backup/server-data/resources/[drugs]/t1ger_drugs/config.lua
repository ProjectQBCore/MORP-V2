...
Config.Jobs = {
	...
	--cayo
	{ 
		Spot = vector3(5052.44, -4593.11, 2.89),
		Heading = 159.25,
		LockpickPos = vector3(5052.44, -4593.11, 2.89),
		LockpickHeading = 316.11254882812,
		InProgress = false,
		VanSpawned = false,
		GoonsSpawned = false,
		JobPlayer = false,
		Goons = {
			NPC1 = { x = 5057.44, y = -4593.54, z = 2.89, h = 103.08, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
			NPC2 = { x = 5065.66, y = -4591.48, z = 2.87, h = 92.33, ped = 'G_M_Y_MexGang_01', animDict = 'rcmme_amanda1', animName = 'stand_loop_cop', weapon = 'WEAPON_PISTOL', },
			NPC3 = { x = 5059.1, y = -4601.88, z = 2.87, h = 103.14, ped = 'G_M_Y_SalvaBoss_01', animDict = 'amb@world_human_leaning@male@wall@back@legs_crossed@base', animName = 'base', weapon = 'WEAPON_PISTOL' },
			NPC4 = { x = 5075.93, y = -4606.63, z = 2.86, h = 156.56, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
		}
	},
	---sandy
	...
	-- grand senora desert 
	{ 
		Spot = vector3(2348.67, 3134.84, 48.12),
		Heading = 78.68,
		LockpickPos = vector3(2348.67, 3134.84, 48.12),
		LockpickHeading = 316.11254882812,
		InProgress = false,
		VanSpawned = false,
		GoonsSpawned = false,
		JobPlayer = false,
		Goons = {
			NPC1 = { x = 2342.93, y = 3140.4, z = 48.21, h = 147.3, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
			NPC2 = { x = 2341.98, y = 3131.28, z = 48.21, h = 19.46, ped = 'G_M_Y_MexGang_01', animDict = 'rcmme_amanda1', animName = 'stand_loop_cop', weapon = 'WEAPON_PISTOL', },
			NPC3 = { x = 2335.07, y = 3137.86, z = 48.19, h = 86.6, ped = 'G_M_Y_SalvaBoss_01', animDict = 'amb@world_human_leaning@male@wall@back@legs_crossed@base', animName = 'base', weapon = 'WEAPON_PISTOL' },
			NPC4 = { x = 2357.39, y = 3119.95, z = 48.21, h = 22.49, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
		}
	},
	-- power station
	{ 
		Spot = vector3(2759.6, 1539.77, 24.33),
		Heading = 75.52,
		LockpickPos = vector3(2348.67, 3134.84, 48.12),
		LockpickHeading = 316.11254882812,
		InProgress = false,
		...
		JobPlayer = false,
		Goons = {
			NPC1 = { x = 2754.47, y = 1541.56, z = 24.5, h = 54.29, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
			NPC2 = { x = 2751.79, y = 1555.75, z = 27.25, h = 93.93, ped = 'G_M_Y_MexGang_01', animDict = 'rcmme_amanda1', animName = 'stand_loop_cop', weapon = 'WEAPON_PISTOL', },
			NPC3 = { x = 2741.16, y = 1553.03, z = 24.5, h = 82.05, ped = 'G_M_Y_SalvaBoss_01', animDict = 'amb@world_human_leaning@male@wall@back@legs_crossed@base', animName = 'base', weapon = 'WEAPON_PISTOL' },
			NPC4 = { x = 2763.5, y = 1531.53, z = 24.5, h = 83.89, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
		}
	},
