...
Config.Stores = {
    [1] =   {shopType = "clothing", x = 1695.52,      y = 4828.94,     z = 42.06},
	[2] =   {shopType = "clothing", x = -712.215881,  y = -155.352982, z = 36.4151268},
	...
	[14] =  {shopType = "clothing", x = -1207.65,     y = -1456.88,    z = 3.37}, --no shop
    ...
    [23] =  {shopType = "clothing", x = 925.17,       y = 22.56,       z = 70.83}
}

Config.ClothingRooms = {
    [2] = {requiredJob = "ambulance", x = 300.16, y = -598.93, z = 43.28, cameraLocation = {x = 301.09, y = -596.09, z = 43.28, h = 157.5}},
    [3] = {requiredJob = "police", x = 1844.8, y = 3693.68, z = 34.27, cameraLocation = {x = 1845.73, y = 3693.68, z = 34.27}},
    [4] = {requiredJob = "police", x = 454.52, y = -988.7, z = 30.69, cameraLocation = {x = 454.52, y = -988.7, z = 30.69}},
    [5] = {requiredJob = "ambulance", x = -250.5, y = 6323.98, z = 32.32, cameraLocation = {x = -250.5, y = 6323.98, z = 32.32, h = 315.5}}, --paleto   
    [6] = {requiredJob = "mvd", x = -942.49, y = -2040.78, z = 9.4, cameraLocation = {x = -942.49, y = -2040.78, z = 9.4, h = 315.5}}, 
	[7] = {requiredJob = "cardealer", x = -1165.83, y = -1688.02, z = 4.56, cameraLocation = { x = -1165.83, y = -1688.02, z = 4.56, h = 247.02}},    
}

Config.Outfits = {
    ["police"] = {
        [1] = {
            outfitLabel = "SWAT - MALE",
            outfitData = {
                ["pants"]       = { item = 130, texture = 1},  -- Broek
        ...
        [2] = {
            outfitLabel = "SWAT - FEMALE",
            outfitData = {
                ["pants"]       = { item = 102, texture = 0},  -- Broek
                ["arms"]        = { item = 23,  texture = 0},  -- Armen
                ["t-shirt"]     = { item = 34,  texture = 0},  -- T Shirt
                ["vest"]        = { item = 17,  texture = 0},  -- Body Vest
                ["torso2"]      = { item = 103, texture = 0},  -- Jas / Vesten
                ["shoes"]       = { item = 24,  texture = 0},  -- Schoenen
                ["decals"]      = { item = 14,  texture = 2},  -- Decals
                ["accessory"]   = { item = 1,   texture = 0},  -- Nek / Das
                ["bag"]         = { item = 0,   texture = 0},  -- Tas
                ["hat"]         = { item = 83,  texture = 0},  -- Pet
        --      ["glass"]       = { item = 0, texture = 0},  -- Bril
        --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                ["mask"]        = { item = 52, texture = 0},  -- Masker
            },
        ...
        [3] = {
            outfitLabel = "FROMAL - MALE",
            outfitData = {
                ["pants"]       = { item = 28, texture = 0},  -- Broek
        ...
        --      ["glass"]       = { item = 0, texture = 0},  -- Bril
        --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                ["mask"]         = { item = 0, texture = 1},  -- Masker
            },
        },
        [4] = {
            outfitLabel = "FROMAL - FEMALE",
            outfitData = {
                ["pants"]       = { item = 37, texture = 0},  -- Broek
                ["arms"]        = { item = 14, texture = 0},  -- Armen
                ["t-shirt"]     = { item = 34, texture = 0},  -- T Shirt
                ["vest"]        = { item = 0,  texture = 0},  -- Body Vest
                ["torso2"]      = { item = 89, texture = 0},  -- Jas / Vesten
                ["shoes"]       = { item = 29, texture = 0},  -- Schoenen
                ["decals"]      = { item = 0,  texture = 0},  -- Decals
                ["accessory"]   = { item = -1, texture = 0},  -- Nek / Das
                ["bag"]         = { item = 0,  texture = 0},  -- Tas
                ["hat"]         = { item = -1, texture = 0},  -- Pet
                ["glass"]       = { item = 11, texture = 0},  -- Bril
                ["ear"]         = { item = 20, texture = 0},  -- Oor accessoires
                ["mask"]        = { item = -1, texture = 0},  -- Masker
            },
        },
        [5] = {
            outfitLabel = "CASUAL - MALE",
            outfitData = {
                ["pants"]       = { item = 28, texture = 0},  -- Broek
        ...
        [6] = {
            outfitLabel = "CASUAL - FEMALE",
            outfitData = {
                ["pants"]       = { item = 37, texture = 2},  -- Broek
                ["arms"]        = { item = 14, texture = 0},  -- Armen
                ["t-shirt"]     = { item = 34, texture = 0},  -- T Shirt
                ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                ["torso2"]      = { item = 99, texture = 0},  -- Jas / Vesten
                ["shoes"]       = { item = 29, texture = 0},  -- Schoenen
                ["decals"]      = { item = 0,  texture = 0},  -- Decals
                ["accessory"]   = { item = -1,  texture = 0},  -- Nek / Das
                ["bag"]         = { item = 0,  texture = 0},  -- Tas
    ...
    ["ambulance"] = {
            [1] = {
                outfitLabel = "male",
                outfitData = {
                    ["pants"]       = { item = 116,texture = 4},  -- Broek
                    ["arms"]        = { item = 88, texture = 1},  -- Armen
                    ["t-shirt"]     = { item = 15, texture = 0},  -- T Shirt
                    ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 200, texture = 1},  -- Jas / Vesten
                    ["shoes"]       = { item = 10, texture = 0},  -- Schoenen
                    ["decals"]      = { item = 0, texture = 0},  -- Decals
    ...
    ["mvd"] = {
        [1] = {
            outfitLabel = "MVD OFFICER - MALE",
            outfitData = {
                ["pants"]       = { item = 10, texture = 5},  -- Broek
                ["arms"]        = { item = 20, texture = 0},  -- Armen
                ["t-shirt"]     = { item = 37, texture = 1},  -- T Shirt
                ["vest"]        = { item = 0, texture = 0},  -- Body Vest
                ["torso2"]      = { item = 26, texture = 0},  -- Jas / Vesten
                ["shoes"]       = { item = 11, texture = 9},  -- Schoenen
                ["decals"]      = { item = 0, texture = 0},  -- Decals
                ["accessory"]   = { item = 1, texture = 0},  -- Nek / Das
                ["bag"]         = { item = 0, texture = 0},  -- Tas
                ["hat"]         = { item = -1, texture = 0},  -- Pet
