        ...
        if veh and DoesEntityExist(veh) and GetEntityModel(veh) == GetHashKey("flatbed3") and NetworkHasControlOfEntity(veh) then
            ...
            if bedNet ~= 0 then
                ...
                if state == 0 then
                    ...
                    if drawMarker(controllerPos) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mvd' then
                        showHelpText(controllerMessageRaised)
                        if IsControlJustPressed(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mvd' then
                            state = 1
                ...
                elseif state == 3 then
                    ...
                    if drawMarker(controllerPos) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mvd' then
                        ...
                        if IsControlJustPressed(0, 47) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mvd' then
                            if attached then
