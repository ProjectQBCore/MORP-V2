...
// Click functions
if (Config.useESX) {
    $("#hunger-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'hunger' })); });
    $("#thirst-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'thirst' })); });
    if (Config.useStress) {
        $("#stress-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'stress' })); });
    };
};
$("#health-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'health' })); });
$("#armor-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'armor' })); });
$("#stamina-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'stamina' })); });
$("#oxygen-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'oxygen' })) });
$("#map-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'map' })) });
$("#id-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'id' })) });
$("#cinematic-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'cinematic' })) });
$("#time-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'time' })) });
$("#microphone-switch").click(function() { $.post('https://MORP_hud/change', JSON.stringify({ action: 'microphone' })) });
$("#reset").click(function() { $("#drag-browser").animate({ top: "", left: "50%" }); });
$("#close").click(function() { $.post('https://MORP_hud/close'); });
