...
ESX.RegisterServerCallback('inventory:getPlayerInventory', function(source, cb)
...
function ensurePlayerInventory(player)
    ...
    loadInventory(player.identifier, 'player', function()
        applyToInventory(player.identifier, 'player', function(inventory)
            ...
            TriggerClientEvent('inventory:refreshInventory', player.source)
        end)
    end)
end

RegisterServerEvent('inventory:notifyImpendingRemoval')
AddEventHandler('inventory:notifyImpendingRemoval', function(item, count, playerSource)
...
RegisterServerEvent('inventory:notifyImpendingAddition')
AddEventHandler('inventory:notifyImpendingAddition', function(item, count, playerSource)
    local _source = playerSource or source
...
AddEventHandler('esx:onRemoveInventoryItem', function(source, item, count)
    ...
    TriggerClientEvent('inventory:showItemUse', source, {
